  ...
  <figure class="flex flex-col">
    ...
    >
      <div class="flex justify-between">
        ...
        >
          <HeartIcon
            class="h-6 stroke-indigo-500 hover:fill-indigo-500"
          ></HeartIcon>
        </div>
      </div>
      ...
      <div class="flex justify-between">
        ...
        <div class="flex items-center gap-2">
          ...
          <span class="text-xs text-gray-500"><slot>2 Bathrooms</slot></span>
        </div>
        <div class="flex items-center gap-2">
...
import superficie from "./superficie.vue";
